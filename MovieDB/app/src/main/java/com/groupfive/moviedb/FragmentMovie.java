                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(getActivity(), "Gagal SEACRH Menampilkan Data!", Toast.LENGTH_SHORT).show();
                        }
                    }
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(getActivity(), "Gagal MOVIE HORIZONTAL Menampilkan Data!", Toast.LENGTH_SHORT).show();
                        }
                    }
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(getActivity(), "Gagal MOVIE ALL Menampilkan Data!", Toast.LENGTH_SHORT).show();
                        }
                    }
